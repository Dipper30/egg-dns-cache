...
class DnsResolver {
   ...
   * @param {Array<String>} defaultServers - Custom DNS nameservers
   * @private
   */
   ...
   * @param {Object} record - DNS record with rotation state
   ...
   * @param {String} mode - 'lookup' or 'resolve'
   * @private
   */
  _debugDNS(err, mode) {
  ...
  /**
   * Clear the DNS cache
   * @param {Boolean} recreate - Whether to recreate the cache instance, default is false.
